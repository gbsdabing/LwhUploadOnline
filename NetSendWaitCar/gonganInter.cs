...
namespace NetSendWaitCar
{
    ...
    public partial class AccessService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public AccessService() {
            this.Url = "http://192.168.101.100:83/Services/AccessService.asmx";
        }
        public AccessService(string url)
        {
            if (url == "")
                this.Url = "http://192.168.101.100:83/Services/AccessService.asmx";
            else
